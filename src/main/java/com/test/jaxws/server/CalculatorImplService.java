 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://server.jaxws.test.com/", wsdlLocation = "http://localhost:30647/TestJaxwsServer/CalculatorImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://server.jaxws.test.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:30647/TestJaxwsServer/CalculatorImplService?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://server.jaxws.test.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jaxws.test.com/", "CalculatorImplPort"), Calculator.class, features);
    }
