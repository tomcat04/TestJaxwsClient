 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://server.jaxws.test.com/}personBean" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetPersonListResponse {
    ...
    protected List<PersonBean> _return;
     ...
     * 
     */
    public List<PersonBean> getReturn() {
        if (_return == null) {
            _return = new ArrayList<PersonBean>();
        }
        return this._return;
    }
